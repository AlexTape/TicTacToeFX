...
public class Model {
    ...
    public final boolean[] isWin(final String matrix) {
        ...
        boolean user1win = (Arrays.asList(this.getWinCombinations())
                .contains(matrix.replace("1", "x").replace("2", "0")));
        boolean user2win = (Arrays.asList(this.getWinCombinations())
     ...
     *
     * @param newMoveCounter the new move counter
     */
     ...
     * Sets the player1.
     *
     * @param newPlayer1 the new player1
     */
     ...
     *
     * @param newPlayer1Color the new player1color
     */
     ...
     * Sets the player2.
     *
     * @param newPlayer2 the new player2
     */
     ...
     *
     * @param newPlayer2Color the new player2color
     */
     ...
     *
     * @param newPlayerColors the new player colors
     */
     ...
     *
     * @param newWinCombinations the new win combinations
     */
